...
std::istream &operator>>(std::istream &is, Date &date)
{
    while (true)
    {
        ...
        {
            // std::cerr << Constants::ANSI::Foreground::RED << "Nhập sai định dạng!" << Constants::ANSI::RESET << std::endl;
            ConsoleUtils::print("Nhập sai định dạng!", {Constants::ANSI::Foreground::RED}, true);
        ...
        if (date.isValid())
            break;
        ConsoleUtils::print("Ngày tháng năm không hợp lệ!", {Constants::ANSI::Foreground::RED}, true);
        ConsoleUtils::ClearLine(0);
    }
    return is;
}
